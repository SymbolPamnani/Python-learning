...
## OOP & Applications
Object-Oriented Design (oop_contacts.py, electronics.py, Inventory_system.py)
GUI applications (hotel_booking.py using Tkinter)
File and exception handling (file-handling.py)
...
Instead of relying purely on theory, I build small scripts to test concepts, resolve edge cases, and refine my understanding of clean code practices.
